...
route.get('/skill/get', [mid.checkWithPermissions(['Kelola Master Data'])], skillController.getSkill);
route.post('/skill/create', [mid.checkWithPermissions(['Kelola Master Data'])], skillController.createSkill);
route.get('/skill/get/:id', [mid.checkWithPermissions(['Kelola Master Data'])], skillController.getSkillById);
